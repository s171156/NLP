...
def reduce_mem_usage(df: pd.DataFrame, verbose=True):
    ...
    Reduce memory usage for pandas DataFrame
     by downcasting to the optimal type for each column in the DataFrame.
    '''
